...
from app.backend_adapter import calculate_character_damage
from app.components import Card, TitleLabel
from app.styles import apply_element_glow, apply_glow
from data.characters_elements import CHARACTER_ELEMENTS
from data.characters_kits import CHARACTER_KITS_DB, MANUAL_CHARACTER_KITS
from data.characters_quotes import CHARACTER_QUOTES
from data.characters_stats import CHARACTER_STATS_DB
from data.images import CHARACTER_IMAGE_FALLBACKS
from data.weapons import MANUAL_WEAPONS, _LOCAL_KIT_WEAPON_NAMES
from app.security_policy import allows_local_image, allows_remote_content
